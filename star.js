...
function animate() {
    ...
    c.drawImage(img, 0, canvas.height - image.height - groundheight, image.width, image.height);
    
    c.fillStyle = "white";
    c.font = "30px serif";
    c.fillText("Happy 2023", canvas.width / 2, 100);
    ...
    if(interval % randomXY(5, 100) == 0) {
        const x = Math.random() * canvas.width
        stars.push(new Star(x, -100, 5, "white"))
    }
